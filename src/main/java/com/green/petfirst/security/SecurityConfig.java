	     ...
	     SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
	        ...
	        http
	            ...
	            .authorizeHttpRequests(authorize -> authorize
	            		...
	            		.requestMatchers("/","/admin/**","/petfir/**", "/public/**").permitAll() //인증 없이 접속 가능하다는 뜻 ("/"):경우 인덱스를 말하는것 
	            		//.requestMatchers("/admin/**").hasRole("ADMIN")
	            		//.requestMatchers("/petfir/**").hasRole("PETFIR") //authorize=권한(role)
	            ...
	            .logout(logout->logout
	            		.logoutSuccessUrl("/")//default //로그아웃 시 인덱스 페이지로 넘어가게끔 설정
